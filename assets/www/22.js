...
/* harmony import */ var _cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./cubic-bezier-eea9a7a9.js */ "bC4P");
/* harmony import */ var _index_34cb2743_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index-34cb2743.js */ "KF81");
/* harmony import */ var _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./helpers-1457892a.js */ "W6o/");
...
/* harmony import */ var _gesture_controller_31cb6bb9_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./gesture-controller-31cb6bb9.js */ "y08P");
...
var createSwipeToCloseGesture = function createSwipeToCloseGesture(el, animation, onDismiss) {
  ...
  var onMove = function onMove(detail) {
    var step = Object(_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_13__["k"])(0.0001, detail.deltaY / height, 0.9999);
  ...
  var onEnd = function onEnd(detail) {
    ...
    if (!shouldComplete) {
      ...
      newStepValue += Object(_cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_11__["g"])([0, 0], [1, 0], [0.68, 0.28], [1, 1], step)[0];
    } else {
      animation.easing('cubic-bezier(0.32, 0.72, 0, 1)');
      newStepValue += Object(_cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_11__["g"])([0, 0], [0.32, 0.72], [0, 1], [1, 1], step)[0];
    }
  ...
  var gesture = Object(_index_34cb2743_js__WEBPACK_IMPORTED_MODULE_12__["createGesture"])({
    el: el,
...
var computeDuration = function computeDuration(remaining, velocity) {
  return Object(_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_13__["k"])(400, remaining / Math.abs(velocity * 1.1), 500);
};
/**
...
var iosEnterAnimation = function iosEnterAnimation(baseEl, presentingEl) {
  var backdropAnimation = Object(_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_10__["c"])().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
  var wrapperAnimation = Object(_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_10__["c"])().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
    'opacity': 1
  }).fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
  var baseAnimation = Object(_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_10__["c"])().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

  if (presentingEl) {
    var isMobile = window.innerWidth < 768;
    var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    var presentingAnimation = Object(_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_10__["c"])().beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        var shadowAnimation = Object(_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_10__["c"])().afterStyles({
          'transform': _finalTransform
...
var iosLeaveAnimation = function iosLeaveAnimation(baseEl, presentingEl) {
  ...
  var backdropAnimation = Object(_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_10__["c"])().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 0.0);
  var wrapperAnimation = Object(_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_10__["c"])().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
    'opacity': 1
  }).fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
  var baseAnimation = Object(_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_10__["c"])().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

  if (presentingEl) {
    var isMobile = window.innerWidth < 768;
    var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    var presentingAnimation = Object(_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_10__["c"])().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(function (currentStep) {
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        var shadowAnimation = Object(_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_10__["c"])().addElement(presentingEl.querySelector('.modal-shadow')).afterStyles({
          'transform': 'translateY(0) scale(1)'
        }).keyframes([{
          offset: 0,
          opacity: '0',
...
var Modal = /*#__PURE__*/function () {
  function Modal(hostRef) {
    ...
    Object(_Users_bancolombia_Documents_NEQUI_APP_GITHUB_PDN_nequi_core_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Modal);

    Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_4__["r"])(this, hostRef);
    this.didPresent = Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this, "ionModalDidPresent", 7);
    this.willPresent = Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this, "ionModalWillPresent", 7);
    this.willDismiss = Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this, "ionModalWillDismiss", 7);
    this.didDismiss = Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this, "ionModalDidDismiss", 7); // Whether or not modal is being dismissed via gesture
  ...
  Object(_Users_bancolombia_Documents_NEQUI_APP_GITHUB_PDN_nequi_core_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Modal, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              _context.next = 8;
              return Object(_framework_delegate_94e770cc_js__WEBPACK_IMPORTED_MODULE_6__["a"])(this.delegate, container, this.component, ['ion-page'], componentProps);
            ...
            case 11:
              ...
              _context.next = 14;
              return Object(_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_7__["d"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
    ...
    value: function initSwipeToClose() {
      ...
      var animationBuilder = this.leaveAnimation || _ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_5__["c"].get('modalLeave', iosLeaveAnimation);
      ...
      this.gesture = createSwipeToCloseGesture(this.el, ani, function () {
        ...
        _this3.animation.onFinish( /*#__PURE__*/Object(_Users_bancolombia_Documents_NEQUI_APP_GITHUB_PDN_nequi_core_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    key: "dismiss",
    value: function () {
      var _dismiss2 = Object(_Users_bancolombia_Documents_NEQUI_APP_GITHUB_PDN_nequi_core_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data, role) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              enteringAnimation = _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_7__["h"].get(this) || [];
              _context3.next = 5;
              return Object(_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_7__["f"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);
    ...
    value: function onDidDismiss() {
      return Object(_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_7__["g"])(this.el, 'ionModalDidDismiss');
    }
    /**
    ...
    value: function onWillDismiss() {
      return Object(_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_7__["g"])(this.el, 'ionModalWillDismiss');
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_4__["h"])(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_4__["H"], Object.assign({
        ...
        class: Object.assign((_Object$assign = {}, Object(_Users_bancolombia_Documents_NEQUI_APP_GITHUB_PDN_nequi_core_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_Object$assign, mode, true), Object(_Users_bancolombia_Documents_NEQUI_APP_GITHUB_PDN_nequi_core_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_Object$assign, "modal-card", this.presentingElement !== undefined && mode === 'ios'), _Object$assign), Object(_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_8__["g"])(this.cssClass)),
      ...
      }), mode === 'ios' && Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_4__["h"])("div", {
        class: "modal-shadow"
